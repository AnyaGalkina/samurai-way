...
export const setFilters = (filters: FiltersType ) => {
    return {
        type: SET_FILTERS, payload: {filters}
    } as const;
}

    export const getUsers = (currentPage: number, pageSize: number, filters: FiltersType) => async (dispatch: Dispatch) => {
        ...
        try {
            ...
            let response = await usersAPI.getUsers(currentPage, pageSize, filters.term, filters.friend);
